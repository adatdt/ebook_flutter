            ...
            BottomNavigationBarItem(
                icon: Container(
                  ...
                  child: Image.asset(
                    ...
                    width: 14,
                    color: _selectedIndex == 1 ? greenColor : Colors.grey,
                  ),
                ),
                label: ''),
            BottomNavigationBarItem(
                icon: Container(
                  margin: EdgeInsets.only(top: 15),
                  child: Image.asset(
                    'assets/icons/icon-chart.png',
                    width: 20,
                    color: _selectedIndex == 2 ? greenColor : Colors.grey,
                  ),
                ),
                label: ''),
            BottomNavigationBarItem(
                icon: Container(
                  ...
                  child: Image.asset(
                    ...
                    width: 18,
                    color: _selectedIndex == 3 ? greenColor : Colors.grey,
                  ),
                ),
                label: '')
          ]);
