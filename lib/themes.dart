...
Color grayColor = Color(0xFFBDBDBDBD);
Color grayColorSearchField = Color(0xFFF8F8F8F8);
Color greenColor = Color(0xFF098B5C);
Color greyColorRecentBook = Color(0xFFAFAFAF);
Color greyColorInfo = Color(0xFFF7F7F7);
Color deviderColor = Color(0xFF6B6B6B);
Color borderColorRecentBook = Color(0xFFF3F3F3);
Color transparantParentColor = Colors.transparent;

Color greySearchField = Colors.grey.shade100;
...
TextStyle mediumText10 =
    GoogleFonts.poppins(color: deviderColor, fontSize: 10, fontWeight: medium);
